<script lang="ts">
  ...
  const classMap = {
    primary: "bg-primary text-important dark:text-black hover:bg-brand-hover",
    secondary: "bg-salmon hover:bg-salmon-hover focus:bg-salmon-hover",
    tertiary:
      "bg-important dark:bg-primary text-white dark:text-black hover:text-white hover:bg-less-important",
