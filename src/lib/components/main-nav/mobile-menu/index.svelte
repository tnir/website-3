...
{#if $menuState}
  <div
    class="nav-items absolute flex flex-col py-x-small w-screen items-center bg-off-white dark:bg-dark-light-grey space-y-xx-small z-10 shadow-md max-h-screen overflow-y-auto"
  >
